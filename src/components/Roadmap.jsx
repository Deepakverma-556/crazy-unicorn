...
const Roadmap = () => {
  ...
  return (
    <div id='roadmap' className='pt-[231px] max-lg:pt-20 max-sm:pt-16 relative'>
    ...
    <div className='max-w-[1322px] max-lg:gap-5 max-[1200px]:max-w-[1000px] max-[1440px]:max-w-[1140px] w-full justify-center items-center flex flex-col relative max-xl:px-4 mx-auto'>
        ...
        <img className='lg:hidden h-[90%] left-[8%] max-md:left-[10%] max-sm:max-w-[30px] max-sm:object-cover max-sm:left-[6%] absolute' src={RoadmapSmImage} alt="roadmapIMage" />
        <div className='absolute top-[-3%] h-full left-[0%] max-sm:top-[4%] max-sm:left-[0%] max-sm:w-20'>
        <img className='lg:hidden sticky top-[3%] left-[5%]' src={UnicornImage} alt="UnicornImage" />
        </div>
        {ROADMAP_LIST.map((obj, index) => (
          <div key={index} className={`max-md:ml-auto max-sm:max-w-[270px] absolute max-lg:relative max-lg:max-w-[400px] max-lg:top-[unset] max-lg:left-[unset] max-lg:right-[unset] max-[1440px]:max-w-[400px] ${ index === 0 ? 'max-w-[451px] top-[6%] max-[1440px]:left-[-2%] left-[2%] max-[1200px]:left-[2%]' : index === 1 ? 'max-w-[465px] right-[1%] max-[1440px]:right-[3%] max-[1440px]:top-[19%] top-[20%] max-[1200px]:right-[1%]': index === 2 ? 'max-w-[411px] left-[2%] max-[1440px]:left-[-2%] top-[35%] max-[1440px]:top-[33%] max-[1200px]:left-[2%] max-[1200px]:max-w-[370px]' : index === 3 ? 'max-w-[465px] right-[-4%] max-[1440px]:right-[-2%] max-[1440px]:top-[47%] top-[46%] max-[1200px]:max-w-[350px] max-[1200px]:right-[-0%]' : index === 4 ? 'max-w-[397px] left-[2%] top-[60%] max-[1440px]:left-[-2%] max-[1440px]:max-w-[355px] max-[1200px]:left-[2%] max-[1200px]:max-w-[320px]' : 'max-w-[465px]' }`}>
